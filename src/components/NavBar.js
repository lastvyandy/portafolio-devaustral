...
import logo from '../assets/img/logodev1.png';
        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#skills" className={activeLink === 'Lenguajes' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('Lenguajes')}>Lenguajes</Nav.Link>
